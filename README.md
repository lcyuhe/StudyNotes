...
- 选中内容的处理，使用 [selection](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/getSelection) 和 [Range](https://developer.mozilla.org/zh-CN/docs/Web/API/Range), 其中 Range.commonAncestorContainer 对解决问题比较关键
```
